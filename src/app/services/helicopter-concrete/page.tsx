...
export default function Page({}: Props) {
  const style = {
    header: "text-main text-2xl mt-10 mb-5",
      ...
      <div>
        ...
        <div className="grid gap-5 mt-5">
          <div className="md:grid ">
            <div>
              <h4 className={style.h4}>الشوارع</h4>
              <p>
          ...
          <div className="md:grid  ">
            <h4 className={style.h4}>اماكن تحميل الشاحنات</h4>
            <p>
          ...
          <div className="md:grid  ">
            <h4 className={style.h4}>ارضيات المصانع</h4>
            <p>
          ...
          <div className="md:grid  ">
            <h4 className={style.h4}>مهابط طيارة</h4>
            <p>
          ...
          <div className="md:grid  ">
            <h4 className={style.h4}>محطات الوقود - بنزينه</h4>
            <p>
          ...
          <div className="md:grid  ">
            <h4 className={style.h4}>الميناء</h4>
            <p>
          ...
          <div className="md:grid  ">
            <div>
              <h4 className={style.h4}>ارضيات الجراج</h4>
              <p>
        ...
        <div className="md:grid gap-2">
          ...
          <div className="md:grid ">
            <h4 className={style.h4}>التسوية</h4>
            <p className={style.text}>
